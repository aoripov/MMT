...
var ontologyNavigation = {
    ...
    contextMenuEntries: function(target, JOBADInstance) {
        ...
        var hypernyms = locale.translate("Hypernyms", lang);
        var hyponyms = locale.translate("Hyponyms", lang);
    	if (target.hasAttribute(mmtattr.symref)) {
            ...
            menu_entries[hypernyms] = me.getRelated(uri, qmt.tosubject("IsHypernymOf"));
            menu_entries[hyponyms] = me.getRelated(uri, qmt.toobject("IsHypernymOf"));
		}
		return menu_entries;
    },
